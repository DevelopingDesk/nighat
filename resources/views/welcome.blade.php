...
we give first priority to our customer requirments
               ...
               <div class="col-md-4 blc-layer3-grids2">
                <a href="{{route('single.product',$fe->id)}}"><img src="{{asset($fe->image)}}" alt="" ></a>
               </div>
               @endif
               @if($lat !=null)
               <div class="col-md-4 blc-layer3-grids-3 simpleCart_shelfItem">
                 <div class="box-grid">
                    ...
                    <a href="{{route('single.product',$lat->id)}}"><img src="{{asset($lat->image)}}"  height="280px" alt=""></a>
            ...
            <div class="col-md-3 home-grid">
                <div class="home-product-main">
                   <div class="home-product-top">
                      <a href="{{route('single.product',$pr->id)}}"><img src="{{asset($pr->image)}}" alt="" class="img-responsive zoom-img" height="280px"></a>
                   </div>
